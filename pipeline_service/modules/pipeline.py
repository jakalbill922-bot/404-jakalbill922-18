    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        if default_feature:
            ...
            image_edited = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this vivid object in left three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Delete background details. Delete watermarks. Keep object colors. Sharpen image details",
            )
            # 2. Remove background
            image_without_background = self.rmbg.remove_background(image_edited)
            ...
            image_edited_2 = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this vivid object in right three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Delete background details. Delete watermarks. Keep object colors. Sharpen image details",
            )
            ...
            image_edited_3 = self.qwen_edit.edit_image(
                prompt_image=image,
                seed=request.seed,
                prompt="Show this vivid object in back three-quarters view and make sure it is fully visible in space. Turn background black color contrasting with an object. Delete background details. Delete watermarks. Keep object colors. Sharpen image details",
            )
            image_without_background_3 = self.rmbg.remove_background(image_edited_3)
            image_original_without_background = self.rmbg.remove_background(image)
            trellis_result: Optional[TrellisResult] = None
            ...
            trellis_result = self.trellis.generate(
                TrellisRequest(
                    images=[image_original_without_background, image_without_background, image_without_background_2, image_without_background_3],
                    seed=request.seed,
                    params=trellis_params,
                    default=False,
                )
        ...
        if self.settings.send_generated_files:
            ...
            image_without_background_base64 = to_png_base64(image_original_without_background)
